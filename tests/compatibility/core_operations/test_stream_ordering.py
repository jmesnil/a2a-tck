...
_STATE_ORDER: dict[str, int] = {
    TASK_STATE_SUBMITTED.json_value: 0,
    TASK_STATE_WORKING.json_value: 1,
    TASK_STATE_INPUT_REQUIRED.json_value: 1,
    TASK_STATE_AUTH_REQUIRED.json_value: 1,
    TASK_STATE_COMPLETED.json_value: 2,
    TASK_STATE_FAILED.json_value: 2,
    TASK_STATE_CANCELED.json_value: 2,
    TASK_STATE_REJECTED.json_value: 2,
}
